...
class Worker
{
    ...
    protected static function displayUI()
    {
        ...
        if (static::$_OS !== OS_TYPE_LINUX) {
            static::safeEcho("------------------------ Tpstudy ------------------------\r\n");
            static::safeEcho('Tpstudy version:'. static::VERSION. "          PHP version:". PHP_VERSION. "\r\n");
        ...
        //show version
        $line_version = 'Tpstudy version:' . static::VERSION . \str_pad('PHP version:', 22, ' ', STR_PAD_LEFT) . PHP_VERSION . PHP_EOL;
        ...
        if (static::$daemonize) {
            ...
            static::safeEcho("请按 Ctrl+C 停止服务. Start success.\n");
        }
    }
